...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/609241bcdbb0e000165332fa
...
To start editing your site, you can use the Sanity interface at https://dhsbugfix-241bc.sanity.studio/.
...
Generated at `2021-05-05T06:57:26.927Z` by Stackbit version `0.3.51`.